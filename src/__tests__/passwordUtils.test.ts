...
describe("validatePassword", () => {
  ...
  describe("number requirement", () => {
    ...
    it("should reject password with only numbers and letters", () => {
      const password = "MyPassword713";
      const result = PasswordUtils.validatePassword(password);
      expect(result).toBe(false);
    });
  ...
  describe("repeating character prevention", () => {
    ...
    it("should reject password with two consecutive same characters", () => {
      const password = "MyPassss713!";
      const result = PasswordUtils.validatePassword(password);
      expect(result).toBe(false);
    });
  ...
  describe("edge cases", () => {
    ...
    it("should handle null input", () => {
      expect(() => PasswordUtils.validatePassword(null as any)).toThrow();
    });

    it("should handle undefined input", () => {
      expect(() => PasswordUtils.validatePassword(undefined as any)).toThrow();
    });
